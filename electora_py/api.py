...
def verify_proof(compressed_response: str) -> bool:
    ...
    uncompressed_response = json.loads(ungzip(toUint8Array(compressed_response), {"to": "string"}))
    print(uncompressed_response)
    result = connection.verify(uncompressed_response, {"claims": [{"groupId": "0xd65c6f4a9defb6ee9cc90eb344a170e5"}]})
    return result
